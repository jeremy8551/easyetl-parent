...
public class ZipUtils {
     ...
     * @throws IOException
     */
    public static void compress(File fileOrDir, File compressFile, String charsetName, boolean delete) throws IOException {
        Compress compress = BeanFactory.get(Compress.class, FileUtils.getFilenameSuffix(compressFile.getName()));
        try {
     ...
     * @throws IOException
     */
    public static void uncompress(File file, File dir, String charsetName, boolean delete) throws IOException {
        Compress compress = BeanFactory.get(Compress.class, FileUtils.getFilenameSuffix(file.getName()));
        try {
