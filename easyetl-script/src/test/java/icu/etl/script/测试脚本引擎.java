...
//        }
//
//        Assert.assertTrue(!ResourcesUtils.existsMessage("test.msg.stdout"));
//
...
//            String path = FileUtils.joinFilepath(classpath, 测试脚本引擎.class.getPackage().getName().replace('.', '/'), "test.sql");
//
...
//            Assert.assertTrue(value == 0 || value == -3);
//
//            Assert.assertEquals(engine.getContext().getAttribute("testvalue000"), "1000");
//
