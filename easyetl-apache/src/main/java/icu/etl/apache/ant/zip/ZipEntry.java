 ...
 *
 * <p>
 * The extra data is expected to follow the recommendation of {@link <a href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT"> APPNOTE.txt</a>}:
 * </p>
 * <ul>
...
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
	...
	/**
	 * The {@link java.util.zip.ZipEntry} base class only supports the compression methods STORED and DEFLATED. We override the field so that any compression methods can be used.
	 * <p>
	...
	/**
	 * The {@link java.util.zip.ZipEntry#setSize} method in the base class throws an IllegalArgumentException if the size is bigger than 2GB for Java versions < 7. Need to keep our own size information for Zip64 support.
	 */
	private long size = -1;
	 ...
	 *     whether to also return unparseable extra fields as {@link UnparseableExtraFieldData} if such data exists.
	 * @return an array of the extra fields
	 * @since 1.1
	 */
	 ...
	 * @param name
	 *     the name to use created from the raw bytes using the guessed or configured encoding
	 * @param rawName
