 ...
 * "@":  "&#064;"
 */
package icu.etl.apache.ant.unrar.rarfile;
...
public class FileHeader extends BlockHeader {
    ...
    public boolean isSplitBefore() {
        return (this.flags & BaseBlock.LHD_SPLIT_BEFORE) != 0;
    }
    ...
    public boolean isSolid() {
        return (this.flags & BaseBlock.LHD_SOLID) != 0;
    }
    ...
    public boolean isUnicode() {
        return (flags & BaseBlock.LHD_UNICODE) != 0;
    }
    ...
    public boolean hasSalt() {
        return (flags & BaseBlock.LHD_SALT) != 0;
    }

    public boolean isLargeBlock() {
        return (flags & BaseBlock.LHD_LARGE) != 0;
    }
    ...
    public boolean isDirectory() {
        return (flags & BaseBlock.LHD_WINDOWMASK) == BaseBlock.LHD_DIRECTORY;
    }
}
