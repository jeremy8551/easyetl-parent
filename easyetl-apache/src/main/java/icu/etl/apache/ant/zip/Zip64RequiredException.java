...
/**
 * Exception thrown when attempting to write data that requires Zip64 support to an archive and {@link ZipOutputStream#setUseZip64 UseZip64} has been set to {@link Zip64Mode#Never Never}.
 * @since Ant 1.9.0
 */
