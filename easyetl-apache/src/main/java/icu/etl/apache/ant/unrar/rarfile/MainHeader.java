 ...
 */
public class MainHeader extends icu.apache.ant.unrar.rarfile.BaseBlock {
    /** JDK日志输出接口 */
    private final static Logger log = Logger.getLogger(MainHeader.class.getName());
    ...
    public MainHeader(icu.apache.ant.unrar.rarfile.BaseBlock bb, byte[] mainHeader) {
        super(bb);
        int pos = 0;
    ...
    public boolean hasArchCmt() {
        return (this.flags & icu.apache.ant.unrar.rarfile.BaseBlock.MHD_COMMENT) != 0;
    }
    ...
    public boolean isEncrypted() {
        return (this.flags & icu.apache.ant.unrar.rarfile.BaseBlock.MHD_PASSWORD) != 0;
    }
    ...
    public boolean isMultiVolume() {
        return (this.flags & icu.apache.ant.unrar.rarfile.BaseBlock.MHD_VOLUME) != 0;
    }
    ...
    public boolean isFirstVolume() {
        return (this.flags & icu.apache.ant.unrar.rarfile.BaseBlock.MHD_FIRSTVOLUME) != 0;
    }
