...
package icu.etl.apache.ant.zip;
...
public class ZipFile implements java.io.Closeable {
	 ...
	 * 
	 * <p>
	 * For a list of possible values see <a href="http://java.sun.com/j2se/1.5.0/docs/guide/intl/encoding.doc.html">http://java.sun.com/j2se/1.5.0/docs/guide/intl/encoding.doc.html</a>. Defaults to the platform's default character encoding.
	 * </p>
	 */
	 ...
	 * @param name
	 *     name of the entry.
	 * @return the ZipEntry corresponding to the given name - or {@code null} if not present.
	 */
	 ...
	 */
	private static final int CFH_LEN = /* version made by */ZipConstants.SHORT/* version needed to extract */ + ZipConstants.SHORT
	 ...
	 * 
	 * @param noUTF8Flag
	 *     map used to collect entries that don't have their UTF-8 flag set and whose name will be set by data read from the local file header later. The current entry may be added to this map.
	 */
	...
	private void setSizesAndOffsetFromZip64Extra(ZipEntry ze, OffsetEntry offset, int diskStart) throws IOException {
		...
		if (z64 != null) {
			...
			boolean hasRelativeHeaderOffset = offset.headerOffset == ZipConstants.ZIP64_MAGIC;
			z64.reparseCentralDirectoryData(hasUncompressedSize, hasCompressedSize, hasRelativeHeaderOffset, diskStart == ZipConstants.ZIP64_MAGIC_SHORT);
	 ...
	 */
	private static final int MIN_EOCD_SIZE = /* end of central dir signature */ZipConstants.WORD/* number of this disk */ + ZipConstants.SHORT
	 ...
	 */
	private static final int MAX_EOCD_SIZE = MIN_EOCD_SIZE/* maximum length of zipfile comment */ + ZipConstants.ZIP64_MAGIC_SHORT;
	 ...
	 */
	private static final int CFD_LOCATOR_OFFSET = /* end of central dir signature */ZipConstants.WORD/* number of this disk */ + ZipConstants.SHORT
	/* number of the disk with the */
	/* start of the central directory */ + ZipConstants.SHORT
	/* total number of entries in */
	/* the central dir on this disk */ + ZipConstants.SHORT
	 ...
	 */
	private static final int ZIP64_EOCDL_LENGTH = /* zip64 end of central dir locator sig */ZipConstants.WORD
	 ...
	 */
	private static final int ZIP64_EOCDL_LOCATOR_OFFSET = /* zip64 end of central dir locator sig */ZipConstants.WORD
			/* number of the disk with the start */
			/* start of the zip64 end of */
			/* central directory */ + ZipConstants.WORD;
	 ...
	 */
	private static final long LFH_OFFSET_FOR_FILENAME_LENGTH = /* local file header signature */ZipConstants.WORD/* version needed to extract */ + ZipConstants.SHORT
	/* general purpose bit flag */ + ZipConstants.SHORT
	/* compression method */ + ZipConstants.SHORT
	/* last mod file time */ + ZipConstants.SHORT
	/* last mod file date */ + ZipConstants.SHORT
	...
	private void resolveLocalFileHeaderData(Map<ZipEntry, NameAndComment> entriesWithoutUTF8Flag) throws IOException {
		for (Iterator<ZipEntry> it = entries.iterator(); it.hasNext();) {
			...
			offsetEntry.dataOffset = offset + LFH_OFFSET_FOR_FILENAME_LENGTH + ZipConstants.SHORT + ZipConstants.SHORT + fileNameLen + extraFieldLen;
