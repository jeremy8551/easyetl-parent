...
public abstract class AbstractUnicodeExtraField implements ZipExtraField {
	...
	/**
	 * @return The CRC32 checksum of the filename or comment as encoded in the central directory of the zip file.
	 */
	...
	/**
	 * @param nameCRC32
	 *     The CRC32 checksum of the filename as encoded in the central directory of the zip file to set.
	 */
