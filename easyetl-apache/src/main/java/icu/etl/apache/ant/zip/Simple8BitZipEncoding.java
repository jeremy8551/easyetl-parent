 ...
 * <li>All byte codes from 0x80 to 0xff are mapped to a unique unicode character in the range 0x0080 to 0x7fff. (No support for UTF-16 surrogates)
 * </ul>
 * 
 * <p>
...
class Simple8BitZipEncoding implements ZipEncoding {
	 ...
	 * @param c
	 *     The character to encode.
	 * @return Whether the given unicode character is covered by this encoding. If {@code false} is returned, nothing is pushed to the byte buffer.
	 */
	 ...
	 * @return A Simple8BitChar, if this character is covered by this encoding. A {@code null} value is returned, if this character is not covered by this encoding.
	 */
	...
	/**
	 * @see org.apache.tools.zip.ZipEncoding#encodeString(java.lang.String)
	 */
