		...
		try {
			...
			if (p.isMimeType("text/*")) {
				...
				if (s == null)
					return false;
				/*
				 * We invoke our superclass' (i.e., StringTerm) match method. Note however that StringTerm.match() is not optimized for substring searches in large string buffers. We really need to have a StringTerm subclass, say BigStringTerm, with its own match() method that uses a better algorithm .. and then subclass BodyTerm from BigStringTerm.
				 */
