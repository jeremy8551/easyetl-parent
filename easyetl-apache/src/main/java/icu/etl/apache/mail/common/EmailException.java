...
public class EmailException extends Exception {
	...
	/**
	 * Constructs a new <code>EmailException</code> with specified nested <code>Throwable</code> root cause.
	 *
	 * @param rootCause
	...
	/**
	 * Constructs a new <code>EmailException</code> with specified detail message and nested <code>Throwable</code> root cause.
	 *
	 * @param msg
	 *            the error message.
	 * @param rootCause
