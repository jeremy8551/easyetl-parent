...
public class MimeType implements Externalizable {
	...
	/**
	 * A simple parser test, for debugging...
	 *
	 * public static void main(String[] args) throws MimeTypeParseException, IOException { for (int i = 0; i < args.length; ++i) { System.out.println("Original: " + args[i]);
	 * 
	 * MimeType type = new MimeType(args[i]);
	 * 
	 * System.out.println("Short: " + type.getBaseType()); System.out.println("Parsed: " + type.toString()); System.out.println(); } }
	 */
}
