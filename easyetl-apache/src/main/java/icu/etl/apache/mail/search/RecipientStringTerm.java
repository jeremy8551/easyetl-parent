 ...
 * <p>
 *
 * Note that this class differs from the <code>RecipientTerm</code> class in that this class does comparisons on address strings rather than Address objects. The string comparisons are case-insensitive.
 *
 * @since JavaMail 1.1
 */
