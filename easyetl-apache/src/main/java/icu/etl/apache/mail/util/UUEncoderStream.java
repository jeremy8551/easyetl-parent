...
public class UUEncoderStream extends FilterOutputStream {
	...
	public void write(int c) throws IOException {
		/*
		 * buffer up characters till we get a line's worth, then encode and write them out. Max number of characters allowed per line is 45.
		 */
	...
	/****
	 * begin TEST program ***** public static void main(String argv[]) throws Exception { FileInputStream infile = new FileInputStream(argv[0]); UUEncoderStream encoder = new UUEncoderStream(System.out); int c;
	 * 
