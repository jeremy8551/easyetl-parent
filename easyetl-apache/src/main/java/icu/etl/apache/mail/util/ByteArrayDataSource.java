...
public class ByteArrayDataSource implements DataSource {
	...
	/**
	 * Create a ByteArrayDataSource with data from the specified String and with the specified MIME type. The MIME type should include a <code>charset</code> parameter specifying the charset to be used for the string. If the parameter is not included, the default charset is used.
	 *
	 * @param data
	 *            the String
	 * @param type
	...
	/**
	 * Return an OutputStream for the data. Writing the data is not supported; an <code>IOException</code> is always thrown.
	 *
	 * @exception IOException
	 *                always
	 */
