...
import icu.etl.apache.mail.search.AddressTerm;
import icu.etl.apache.mail.search.AndTerm;
import icu.etl.apache.mail.search.BodyTerm;
import icu.etl.apache.mail.search.ComparisonTerm;
import icu.etl.apache.mail.search.DateTerm;
import icu.etl.apache.mail.search.FlagTerm;
import icu.etl.apache.mail.search.FromStringTerm;
import icu.etl.apache.mail.search.FromTerm;
import icu.etl.apache.mail.search.HeaderTerm;
import icu.etl.apache.mail.search.MessageIDTerm;
import icu.etl.apache.mail.search.NotTerm;
import icu.etl.apache.mail.search.OrTerm;
import icu.etl.apache.mail.search.ReceivedDateTerm;
import icu.etl.apache.mail.search.RecipientStringTerm;
import icu.etl.apache.mail.search.RecipientTerm;
import icu.etl.apache.mail.search.SearchException;
import icu.etl.apache.mail.search.SearchTerm;
import icu.etl.apache.mail.search.SentDateTerm;
import icu.etl.apache.mail.search.SizeTerm;
import icu.etl.apache.mail.search.StringTerm;
import icu.etl.apache.mail.search.SubjectTerm;
...
class SearchSequence {
	...
	private static Argument or(OrTerm term, String charset) throws SearchException, IOException {
		...
		/*
		 * The IMAP OR operator takes only two operands. So if we have more than 2 operands, group them into 2-operand OR Terms.
		 */
		if (terms.length > 2) {
