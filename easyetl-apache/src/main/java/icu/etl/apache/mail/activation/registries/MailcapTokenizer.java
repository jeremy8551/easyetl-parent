...
public class MailcapTokenizer {
	 ...
	 *
	 * Auto-quoting means that all characters after the first non-whitespace, non-control character up to the auto-quote terminator character or EOI (minus any whitespace immediatley preceeding it) is considered a token.
	 *
