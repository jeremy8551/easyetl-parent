...
/**
 * The DataContentHandler interface is implemented by objects that can be used to extend the capabilities of the DataHandler's implementation of the Transferable interface. Through <code>DataContentHandlers</code> the framework can be extended to convert streams in to objects, and to write objects to streams.
 * <p>
 *
...
public interface DataContentHandler {
	...
	/**
	 * Return an object representing the data in its most preferred form. Generally this will be the form described by the first DataFlavor returned by the <code>getTransferDataFlavors</code> method.
	 *
	 * @param ds
	 *            The DataSource representing the data to be converted.
	 * @return The constructed Object.
