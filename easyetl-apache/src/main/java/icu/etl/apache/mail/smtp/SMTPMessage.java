...
public class SMTPMessage extends MimeMessage {
	...
	/**
	 * Constructs a new SMTPMessage with content initialized from the <code>source</code> MimeMessage. The new message is independent of the original.
	 * <p>
	 *
	...
	/**
	 * Set the From address to appear in the SMTP envelope. Note that this is different than the From address that appears in the message itself. The envelope From address is typically used when reporting errors. See <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A> for details.
	 * <p>
	 *
	...
	/**
	 * Set notification options to be used if the server supports Delivery Status Notification (<A HREF="http://www.ietf.org/rfc/rfc1891.txt">RFC 1891</A>). Either <code>NOTIFY_NEVER</code> or some combination of <code>NOTIFY_SUCCESS</code>, <code>NOTIFY_FAILURE</code>, and <code>NOTIFY_DELAY</code>.
	 * <p>
	 *
	...
	/**
	 * Set return option to be used if server supports Delivery Status Notification (<A HREF="http://www.ietf.org/rfc/rfc1891.txt">RFC 1891</A>). Either <code>RETURN_FULL</code> or <code>RETURN_HDRS</code>.
	 * <p>
	 *
	...
	/**
	 * Sets the submitter to be used for the RFC 2554 AUTH= value in the MAIL FROM command. Normally only used by a server that's relaying a message. Clients will typically not set a submitter. See <A HREF="http://www.ietf.org/rfc/rfc2554.txt">RFC 2554</A> for details.
	 *
	 * @param submitter
	...
	/**
	 * Set the extension string to use with the MAIL command. The extension string can be used to specify standard SMTP service extensions as well as vendor-specific extensions. Typically the application should use the {@link SMTPTransport SMTPTransport} method {@link SMTPTransport#supportsExtension supportsExtension} to verify that the server supports the desired service extension. See <A HREF="http://www.ietf.org/rfc/rfc1869.txt">RFC 1869</A> and other RFCs that define specific extensions.
	 * <p>
	 *
	 * For example:
	 * <p>
