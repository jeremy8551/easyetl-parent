...
public interface CommandObject {
	...
	/**
	 * Initialize the Command with the verb it is requested to handle and the DataHandler that describes the data it will operate on. <b>NOTE:</b> it is acceptable for the caller to pass <i>null</i> as the value for <code>DataHandler</code>.
	 *
	 * @param verb
