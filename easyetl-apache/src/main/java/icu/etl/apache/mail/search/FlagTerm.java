...
public final class FlagTerm extends SearchTerm {
	...
	/**
	 * Indicates whether to test for the presence or absence of the specified Flag. If <code>true</code>, then test whether all the specified flags are present, else test whether all the specified flags are absent.
	 *
	 * @serial
	 */
