...
package icu.etl.apache.mail.search;
 ...
 * <p>
 *
 * <strong>Warning:</strong> Search terms that include references to objects of type <code>Message.RecipientType</code> will not be deserialized correctly on JDK 1.1 systems. While these objects will be deserialized without throwing any exceptions, the resulting objects violate the <i>type-safe enum</i> contract of the <code>Message.RecipientType</code> class. Proper deserialization of these objects depends on support for the <code>readReplace</code> method, added in JDK 1.2.
 *
 * @author Bill Shannon
 * @author John Mani
 */
