 ...
 * <li>The file or resource named <code>META-INF/mimetypes.default</code> (usually found only in the <code>activation.jar</code> file).
 * </ol>
 * <p>
...
public class MimetypesFileTypeMap extends FileTypeMap {
    ...
    public MimetypesFileTypeMap() {
        ...
        if (defDB == null) {
            defDB = ApacheEmailCommand.loadMimetypesDefault();
        }
    ...
    /**
     * Return the MIME type of the file object. The implementation in this class calls <code>getContentType(f.getName())</code>.
     *
     * @param f the file
    ...
    /**
     * Return the MIME type based on the specified file name. The MIME type entries are searched as described above under <i>MIME types file search order</i>. If no entry is found, the type "application/octet-stream" is returned.
     *
     ...
     * for debugging...
     *
     * public static void main(String[] argv) throws Exception { MimetypesFileTypeMap map = new MimetypesFileTypeMap(); System.out.println("File " + argv[0] + " has MIME type " + map.getContentType(argv[0])); System.exit(0); }
     */
}
