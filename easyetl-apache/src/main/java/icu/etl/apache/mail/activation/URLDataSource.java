...
/**
 * The URLDataSource class provides an object that wraps a <code>URL</code> object in a DataSource interface. URLDataSource simplifies the handling of data described by URLs within the JavaBeans Activation Framework because this class can be used to create new DataHandlers. <i>NOTE: The DataHandler object creates a URLDataSource internally, when it is constructed with a URL.</i>
 *
 * @see DataSource
 * @see DataHandler
 */
public class URLDataSource implements DataSource {
	...
	/**
	 * The getInputStream method from the URL. Calls the <code>openStream</code> method on the URL.
	 *
