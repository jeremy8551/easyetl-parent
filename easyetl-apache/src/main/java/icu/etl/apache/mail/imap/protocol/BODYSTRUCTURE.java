...
import icu.etl.apache.mail.internet.ParameterList;
...
//	    int i = 1;
			do {
				...
				/*
				 * Even though the IMAP spec says there can't be any spaces between parts, some servers erroneously put a space in here. In the spirit of "be liberal in what you accept", we skip it.
				 */
				r.skipSpaces();
			} while (r.peekByte() == '(');
