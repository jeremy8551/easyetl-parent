...
public class SMTPSendFailedException extends SendFailedException {
	...
	/**
	 * Return the return code from the SMTP server that indicates the reason for the failure. See <A HREF="http://www.ietf.org/rfc/rfc821.txt">RFC 821</A> for interpretation of the return code.
	 */
