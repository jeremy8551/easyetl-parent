 ...
 * @see Session#getInstance(java.util.Properties, Authenticator)
 * @see Session#getDefaultInstance(java.util.Properties, Authenticator)
...
public abstract class Authenticator {
	 ...
	 * @param protocol
	 *            The protocol that's requesting the connection (@see java.net.Authenticator.getProtocol())
	 * @param prompt
