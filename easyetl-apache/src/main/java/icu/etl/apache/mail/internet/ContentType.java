...
public class ContentType {
	...
	/**
	 * Retrieve a RFC2045 style string representation of this Content-Type. Returns <code>null</code> if the conversion failed.
	 *
	...
	/**
	 * Match with the specified ContentType object. This method compares <strong>only the <code>primaryType</code> and <code>subType</code> </strong>. The parameters of both operands are ignored.
	 * <p>
	 *
	 * For example, this method will return <code>true</code> when comparing the ContentTypes for <strong>"text/plain"</strong> and <strong>"text/plain; charset=foobar"</strong>.
	 *
	 * If the <code>subType</code> of either operand is the special character '*', then the subtype is ignored during the match. For example, this method will return <code>true</code> when comparing the ContentTypes for <strong>"text/plain"</strong> and <strong>"text/*" </strong>
	 *
	 * @param cType
	...
	/**
	 * Match with the specified content-type string. This method compares <strong>only the <code>primaryType</code> and <code>subType</code> </strong>. The parameters of both operands are ignored.
	 * <p>
	 *
	 * For example, this method will return <code>true</code> when comparing the ContentType for <strong>"text/plain"</strong> with <strong>"text/plain; charset=foobar"</strong>.
	 *
	 * If the <code>subType</code> of either operand is the special character '*', then the subtype is ignored during the match. For example, this method will return <code>true</code> when comparing the ContentType for <strong>"text/plain"</strong> with <strong>"text/*" </strong>
	 */
