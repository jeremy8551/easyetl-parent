...
public class Rights implements Cloneable {
	...
	/*****
	 * public static void main(String argv[]) throws Exception { // a new rights object Rights f1 = new Rights(); f1.add(Rights.Right.READ); f1.add(Rights.Right.WRITE); f1.add(Rights.Right.CREATE); f1.add(Rights.Right.DELETE);
	 * 
	 * // check copy constructor Rights fc = new Rights(f1); if (f1.equals(fc) && fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * // check clone fc = (Rights)f1.clone(); if (f1.equals(fc) && fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * // add a right and make sure it still works right f1.add(Rights.Right.ADMINISTER);
	 * 
	 * // shouldn't be equal here if (!f1.equals(fc) && !fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * // check clone fc = (Rights)f1.clone(); if (f1.equals(fc) && fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * fc.add(Rights.Right.INSERT); if (!f1.equals(fc) && !fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * // check copy constructor fc = new Rights(f1); if (f1.equals(fc) && fc.equals(f1)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * // another new rights object Rights f2 = new Rights(Rights.Right.READ); f2.add(Rights.Right.WRITE);
	 * 
	 * if (f1.contains(Rights.Right.READ)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.WRITE)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.CREATE)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * if (f1.contains(Rights.Right.DELETE)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * if (f2.contains(Rights.Right.WRITE)) System.out.println("success"); else System.out.println("fail");
	 * 
	 * 
	 * System.out.println("----------------");
	 * 
	 * Right[] r = f1.getRights(); for (int i = 0; i < r.length; i++) System.out.println(r[i]); System.out.println("----------------");
	 * 
	 ...
	 * 
	 * Rights f3 = new Rights(); f3.add(Rights.Right.READ); f3.add(Rights.Right.WRITE); f3.add(Rights.Right.CREATE); f3.add(Rights.Right.DELETE); f3.add(Rights.Right.ADMINISTER); f3.add(Rights.Right.LOOKUP);
	 * 
