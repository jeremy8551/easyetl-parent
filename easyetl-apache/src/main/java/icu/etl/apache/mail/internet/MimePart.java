...
/**
 * The MimePart interface models an <strong>Entity</strong> as defined by MIME (RFC2045, Section 2.4).
 * <p>
 *
...
public interface MimePart extends Part {
	...
	/**
	 * Get the values of all header fields available for this header, returned as a single String, with the values separated by the delimiter. If the delimiter is <code>null</code>, only the first value is returned.
	 *
	 * @param name
	...
	/**
	 * Get the language tags specified in the Content-Language header of this MimePart. The Content-Language header is defined by RFC 1766. Returns <code>null</code> if this header is not available.
	 */
