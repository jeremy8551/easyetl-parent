	...
	public MailboxInfo(Response[] r) throws ParsingException {
		for (int i = 0; i < r.length; i++) {
			...
			if (ir.keyEquals("EXISTS")) {
				...
				/*
				 * should be one of: OK [UNSEEN 12] OK [UIDVALIDITY 3857529045] OK [PERMANENTFLAGS (\Deleted)] OK [UIDNEXT 44]
				 */
				ir.skipSpaces();
		...
		/*
		 * The PERMANENTFLAGS response code is optional, and if not present implies that all flags in the required FLAGS response can be changed permanently.
		 */
