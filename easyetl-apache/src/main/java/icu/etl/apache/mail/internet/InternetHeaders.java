...
public class InternetHeaders {
	...
	protected static final class InternetHeader extends Header {
		/*
		 * Note that the value field from the superclass isn't used in this class. We extract the value from the line field as needed. We store the line rather than just the value to ensure that we can get back the exact original line, with the original whitespace, etc.
		 */
	...
	/*
	 * The enumeration object used to enumerate an InternetHeaders object. Can return either a String or a Header object.
	 */
	static class matchEnum implements Enumeration {
		...
		/*
		 * Constructor. Initialize the enumeration for the entire List of headers, the set of headers, whether to return matching or non-matching headers, and whether to return header lines or Header objects.
		 */
		...
		/*
		 * Return the next Header object according to the match criteria, or null if none left.
		 */
	...
	/**
	 * Get all the headers for this header name, returned as a single String, with headers separated by the delimiter. If the delimiter is <code>null</code>, only the first header is returned. Returns <code>null</code> if no headers with the specified name exist.
	 *
	 * @param name
	 *            header name
	 * @param delimiter
