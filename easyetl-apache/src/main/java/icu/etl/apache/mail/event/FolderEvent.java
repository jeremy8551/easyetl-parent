...
/**
 * This class models Folder <em>existence</em> events. FolderEvents are delivered to FolderListeners registered on the affected Folder as well as the containing Store.
 * <p>
 *
