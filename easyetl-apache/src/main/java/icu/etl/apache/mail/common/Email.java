 ...
 */
package icu.etl.apache.mail.common;
...
import icu.etl.apache.mail.internet.AddressException;
...
import icu.etl.apache.mail.Authenticator;
 ...
 * @version $Revision: 577476 $ $Date: 2007-09-19 16:50:30 -0700 (Wed, 19 Sep 2007) $
 * @version $Id: Email.java 577476 2007-09-19 23:50:30Z bspeakmon $
 */
...
public abstract class Email {
	...
	/**
	 * Instance of an <code>Authenticator</code> object that will be used when authentication is requested from the mail server.
	 */
	...
	/**
	 * Address to which undeliverable mail should be sent. Because this is handled by JavaMail as a String property in the mail session, this property is of type <code>String</code> rather than <code>InternetAddress</code>.
	 */
	 ...
	 * <p>
	 * This method will create a new instance of <code>DefaultAuthenticator</code> using the supplied parameters.
	 *
	 * @param userName
	...
	/**
	 * Sets the <code>Authenticator</code> to be used when authentication is requested from the mail server.
	 * <p>
	 ...
	 *             if no support for the named charset exists in the current JavaUtils
	 * @since 1.0
	 */
	 ...
	 * 
	 * @param jndiName
	 *            name of JNDI ressource (javax.mail.Session type), ressource if searched in java:comp/env if name dont start with "java:"
	...
	public Session getMailSession() throws EmailException {
		if (this.session == null) {
			...
			if (this.ssl) {
				...
				properties.setProperty(MAIL_SMTP_SOCKET_FACTORY_CLASS, SSLSocketFactory.class.getName());
	...
	/**
	 * Set the FROM field of the email to use the specified address. The email address will also be used as the personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @return An Email.
	...
	/**
	 * Set the FROM field of the email to use the specified address and the specified personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @param name
	...
	/**
	 * Add a recipient TO to the email. The email address will also be used as the personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @throws EmailException
	...
	/**
	 * Add a recipient TO to the email using the specified address and the specified personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @param name
	...
	/**
	 * Set a list of "TO" addresses. All elements in the specified <code>Collection</code> are expected to be of type <code>java.mail.internet.InternetAddress</code>.
	 *
	 * @param aCollection
	...
	/**
	 * Add a recipient CC to the email. The email address will also be used as the personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @return An Email.
	...
	/**
	 * Add a recipient CC to the email using the specified address and the specified personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @param name
	...
	/**
	 * Set a list of "CC" addresses. All elements in the specified <code>Collection</code> are expected to be of type <code>java.mail.internet.InternetAddress</code>.
	 *
	 * @param aCollection
	 *            collection of <code>InternetAddress</code> objects.
	 * @return An Email.
	...
	/**
	 * Add a blind BCC recipient to the email. The email address will also be used as the personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @return An Email.
	...
	/**
	 * Add a blind BCC recipient to the email using the specified address and the specified personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @param name
	...
	/**
	 * Set a list of "BCC" addresses. All elements in the specified <code>Collection</code> are expected to be of type <code>java.mail.internet.InternetAddress</code>.
	 *
	 * @param aCollection
	 *            collection of <code>InternetAddress</code> objects
	 * @return An Email.
	...
	/**
	 * Add a reply to address to the email. The email address will also be used as the personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @return An Email.
	...
	/**
	 * Add a reply to address to the email using the specified address and the specified personal name. The name will be encoded using the Java platform's default charset (UTF-16) if it contains non-ASCII characters; otherwise, it is used as is.
	 *
	 * @param email
	 *            A String.
	 * @param name
	...
	/**
	 * Set a list of reply to addresses. All elements in the specified <code>Collection</code> are expected to be of type <code>java.mail.internet.InternetAddress</code>.
	 *
	 * @param aCollection
	 *            collection of <code>InternetAddress</code> objects
	 * @return An Email.
