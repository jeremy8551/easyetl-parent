...
public class QPEncoderStream extends FilterOutputStream {
	...
	/****
	 * begin TEST program *** public static void main(String argv[]) throws Exception { FileInputStream infile = new FileInputStream(argv[0]); QPEncoderStream encoder = new QPEncoderStream(System.out); int c;
	 * 
