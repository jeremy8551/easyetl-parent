...
package icu.etl.apache.mail.dsn;
...
import icu.etl.apache.mail.activation.ActivationDataFlavor;
import icu.etl.apache.mail.activation.DataContentHandler;
...
public class text_rfc822headers implements DataContentHandler {
	...
	private static ActivationDataFlavor myDFs = new ActivationDataFlavor(java.lang.String.class, "text/rfc822-headers", "RFC822 headers");
