...
/**
 * An interface implemented by Stores that support quotas. The {@link #getQuota getQuota} and {@link #setQuota setQuota} methods support the quota model defined by the IMAP QUOTA extension. Refer to <A HREF="http://www.ietf.org/rfc/rfc2087.txt">RFC 2087</A> for more information.
 * <p>
 *
 * @since JavaMail 1.4
 */
