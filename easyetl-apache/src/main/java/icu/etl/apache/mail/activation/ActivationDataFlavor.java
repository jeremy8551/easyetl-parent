...
/**
 * The ActivationDataFlavor class is a special subclass of <code>java.awt.datatransfer.DataFlavor</code>. It allows the JAF to set all three values stored by the DataFlavor class via a new constructor. It also contains improved MIME parsing in the <code>equals
 * </code> method. Except for the improved parsing, its semantics are identical to that of the JDK's DataFlavor class.
 */
...
public class ActivationDataFlavor extends DataFlavor {
	 ...
	 * Raison d'etre:
	 *
	 * The DataFlavor class included in JDK 1.1 has several limitations including piss poor MIME type parsing, and the limitation of only supporting serialized objects and InputStreams as representation objects. This class 'fixes' that.
	 */
	...
	/**
	 * Compares the DataFlavor passed in with this DataFlavor; calls the <code>isMimeTypeEqual</code> method.
	 *
	 * @param dataFlavor
