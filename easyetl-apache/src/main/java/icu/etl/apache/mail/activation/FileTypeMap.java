...
public abstract class FileTypeMap {
	...
	/**
	 * Return the default FileTypeMap for the system. If setDefaultFileTypeMap was called, return that instance, otherwise return an instance of <code>MimetypesFileTypeMap</code>.
	 *
