...
public abstract class CommandMap {
	 ...
	 *
	 * <ul>
	 * <li>In cases where a CommandMap instance has been previously set to some value (via <i>setDefaultCommandMap</i>) return the CommandMap.
	 * <li>In cases where no CommandMap has been set, the CommandMap creates an instance of <code>MailcapCommandMap</code> and set that to the default, returning its value.
	 *
	 * </ul>
	 *
	...
	/**
	 * Set the default CommandMap. Reset the CommandMap to the default by calling this method with <code>null</code>.
	 *
	 * @param commandMap
	 ...
	 * <p>
	 *
	 * The <code>DataSource</code> provides extra information, such as the file name, that a CommandMap implementation may use to further refine the list of commands that are returned. The implementation in this class simply calls the <code>getPreferredCommands</code> method that ignores this argument.
	 *
	 * @param mimeType
	 *            the MIME type
	 * @param ds
	 ...
	 * <p>
	 *
	 * The <code>DataSource</code> provides extra information, such as the file name, that a CommandMap implementation may use to further refine the list of commands that are returned. The implementation in this class simply calls the <code>getAllCommands</code> method that ignores this argument.
	 *
	 * @param mimeType
	 *            the MIME type
	 * @param ds
	 ...
	 * <p>
	 *
	 * The <code>DataSource</code> provides extra information, such as the file name, that a CommandMap implementation may use to further refine the command that is chosen. The implementation in this class simply calls the <code>getCommand</code> method that ignores this argument.
	 *
	 * @param mimeType
	 *            the MIME type
	 * @param cmdName
	 ...
	 * <p>
	 *
	 * The <code>DataSource</code> provides extra information, such as the file name, that a CommandMap implementation may use to further refine the choice of DataContentHandler. The implementation in this class simply calls the <code>createDataContentHandler</code> method that ignores this argument.
	 *
	 * @param mimeType
	 *            the MIME type
	 * @param ds
