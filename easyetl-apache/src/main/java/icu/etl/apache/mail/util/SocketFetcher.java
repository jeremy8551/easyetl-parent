...
public class SocketFetcher {
	...
	public static Socket startTLS(Socket socket) throws IOException {
		...
		try {
			...
			/*
			 * At least the UW IMAP server insists on only the TLSv1 protocol for STARTTLS, and won't accept the old SSLv2 or SSLv3 protocols. Here we enable only the TLSv1 protocol. XXX - this should probably be parameterized.
			 */
