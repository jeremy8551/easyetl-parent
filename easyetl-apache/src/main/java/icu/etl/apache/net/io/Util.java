...
public final class Util {
	/***
	 * The default buffer size used by {@link #copyStream copyStream } and {@link #copyReader copyReader }. It's value is 1024.
	 ***/
	 ...
	 * @param streamSize
	 *            The number of bytes in the stream being copied. Should be set to CopyStreamEvent.UNKNOWN_STREAM_SIZE if unknown.
	 * @param listener
	 *            The CopyStreamListener to notify of progress. If this parameter is null, notification is not attempted.
	 * @param flush
	 *            Whether to flush the output stream after every write. This is necessary for interactive sessions that rely on buffered streams. If you don't flush, the data will stay in the stream buffer.
	 ...
	 * @param streamSize
	 *            The number of characters in the stream being copied. Should be set to CopyStreamEvent.UNKNOWN_STREAM_SIZE if unknown.
	 * @param listener
	 *            The CopyStreamListener to notify of progress. If this parameter is null, notification is not attempted.
