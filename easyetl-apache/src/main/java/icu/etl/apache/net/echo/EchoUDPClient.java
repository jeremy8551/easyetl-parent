...
import icu.etl.apache.net.discard.DiscardUDPClient;

/***
 * The EchoUDPClient class is a UDP implementation of a client for the Echo protocol described in RFC 862. To use the class, just open a local UDP port with {@link DatagramSocketClient#open open } and call {@link #send send } to send datagrams to the server, then call {@link #receive receive } to receive echoes. After you're done echoing data, call {@link DatagramSocketClient#close close() } to clean up properly.
 * <p>
 * <p>
 * 
...
public final class EchoUDPClient extends DiscardUDPClient {
	 ...
	 * @param length
	 *            The length of the data to send. Should be less than or equal to the length of the data byte array.
	 * @param host
