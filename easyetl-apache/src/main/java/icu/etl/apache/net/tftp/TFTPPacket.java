...
public abstract class TFTPPacket {
	...
	/***
	 * The TFTP data packet maximum segment size in bytes. This is 512 and is useful for those familiar with the TFTP protocol who want to use the {@link TFTP} class methods to implement their own TFTP servers or clients.
	 ***/
	...
	/***
	 * Creates a UDP datagram containing all the TFTP packet data in the proper format. This is an abstract method, exposed to the programmer in case he wants to implement his own TFTP client instead of using the {@link TFTPClient} class. Under normal circumstances, you should not have a need to call this method.
	 * <p>
	 * 
