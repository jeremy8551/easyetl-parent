 ...
 */
package icu.etl.apache.net.finger;
...
public class FingerClient extends SocketClient {
	...
	/***
	 * Fingers the connected host and returns the output as a String. You must first connect to a finger server before calling this method, and you should disconnect afterward. This is equivalent to calling <code> query(longOutput, "") </code>.
	 * <p>
	 * 
	 * @param longOutput
	 *            Set to true if long output is requested, false if not.
	 ...
	 *            The name of the user to finger.
	 * @param encoding
	 *            the character encoding that should be used for the query, null for the platform's default encoding
	 * @return The InputStream of the network connection of the finger query. Can be read to obtain finger results.
	 * @exception IOException
	 *                If an I/O error during the operation.
	 ***/
