...
import icu.etl.apache.net.ProtocolCommandListener;
import icu.etl.apache.net.ProtocolCommandSupport;
...
public class FTP extends SocketClient {
	...
	/***
	 * A constant used to indicate the file(s) being transfered should be treated as ASCII. This is the default file type. All constants ending in <code>FILE_TYPE</code> are used to indicate file types.
	 ***/
	public static final int ASCII_FILE_TYPE = 0;
	
	/***
	 * A constant used to indicate the file(s) being transfered should be treated as EBCDIC. Note however that there are several different EBCDIC formats. All constants ending in <code>FILE_TYPE</code> are used to indicate file types.
	 ***/
	public static final int EBCDIC_FILE_TYPE = 1;
	
	/***
	 * A constant used to indicate the file(s) being transfered should be treated as a binary image, i.e., no translations should be performed. All constants ending in <code>FILE_TYPE</code> are used to indicate file types.
	 ***/
	public static final int BINARY_FILE_TYPE = 2;
	
	/***
	 * A constant used to indicate the file(s) being transfered should be treated as a local type. All constants ending in <code>FILE_TYPE</code> are used to indicate file types.
	 ***/
	public static final int LOCAL_FILE_TYPE = 3;
	
	/***
	 * A constant used for text files to indicate a non-print text format. This is the default format. All constants ending in <code>TEXT_FORMAT</code> are used to indicate text formatting for text transfers (both ASCII and EBCDIC).
	 ***/
	public static final int NON_PRINT_TEXT_FORMAT = 4;
	
	/***
	 * A constant used to indicate a text file contains format vertical format control characters. All constants ending in <code>TEXT_FORMAT</code> are used to indicate text formatting for text transfers (both ASCII and EBCDIC).
	 ***/
	public static final int TELNET_TEXT_FORMAT = 5;
	
	/***
	 * A constant used to indicate a text file contains ASA vertical format control characters. All constants ending in <code>TEXT_FORMAT</code> are used to indicate text formatting for text transfers (both ASCII and EBCDIC).
	 ***/
	public static final int CARRIAGE_CONTROL_TEXT_FORMAT = 6;
	
	/***
	 * A constant used to indicate a file is to be treated as a continuous sequence of bytes. This is the default structure. All constants ending in <code>_STRUCTURE</code> are used to indicate file structure for file transfers.
	 ***/
	...
	/***
	 * A constant used to indicate a file is to be transfered as a stream of bytes. This is the default transfer mode. All constants ending in <code>TRANSFER_MODE</code> are used to indicate file transfer modes.
	 ***/
	public static final int STREAM_TRANSFER_MODE = 10;
	
	/***
	 * A constant used to indicate a file is to be transfered as a series of blocks. All constants ending in <code>TRANSFER_MODE</code> are used to indicate file transfer modes.
	 ***/
	public static final int BLOCK_TRANSFER_MODE = 11;
	
	/***
	 * A constant used to indicate a file is to be transfered as FTP compressed data. All constants ending in <code>TRANSFER_MODE</code> are used to indicate file transfer modes.
	 ***/
	...
	/**
	 * Wraps SocketClient._output_ to facilitate the reading of text from the FTP control connection. Do not access the control connection via SocketClient._output_. This member starts with a null value, is initialized in {@link #_connectAction_}, and set to null in {@link #disconnect}.
	 */
	...
	/***
	 * The default FTP constructor. Sets the default port to <code>DEFAULT_PORT</code> and initializes internal data structures for saving FTP reply information.
	 ***/
	public FTP() {
		super();
	...
	/***
	 * Returns the integer value of the reply code of the last FTP reply. You will usually only use this method after you connect to the FTP server to check that the connection was successful since <code> connect </code> is of type void.
	 * <p>
	 * 
	 ...
	 * 
	 * @param fileType
	 *            The type of the file (one of the <code>FILE_TYPE</code> constants).
	 ...
	 * 
	 * @param structure
	 *            The structure of the file (one of the <code>_STRUCTURE</code> constants).
	 * @return The reply code received from the server.
	 * @exception FTPConnectionClosedException
	 *                If the FTP server prematurely closes the connection as a result of the client being idle or some other reason causing the server to send FTP reply code 421. This exception may be caught either as an IOException or independently as itself.
	 * @exception IOException
	 ...
	 * 
	 * @param mode
	 *            The transfer mode to use (one of the <code>TRANSFER_MODE</code> constants).
	 * @return The reply code received from the server.
	 * @exception FTPConnectionClosedException
	 *                If the FTP server prematurely closes the connection as a result of the client being idle or some other reason causing the server to send FTP reply code 421. This exception may be caught either as an IOException or independently as itself.
	 * @exception IOException
	...
	/***
	 * A convenience method to send the FTP RETR command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @param pathname
	...
	/***
	 * A convenience method to send the FTP STOR command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @param pathname
	...
	/***
	 * A convenience method to send the FTP STOU command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @return The reply code received from the server.
	 * @exception FTPConnectionClosedException
	...
	/***
	 * A convenience method to send the FTP APPE command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @param pathname
	 *            The pathname to use for the file when stored at the remote end of the transfer.
	...
	/***
	 * A convenience method to send the FTP LIST command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @return The reply code received from the server.
	 * @exception FTPConnectionClosedException
	...
	/***
	 * A convenience method to send the FTP NLST command to the server, receive the reply, and return the reply code. Remember, it is up to you to manage the data connection. If you don't need this low level of access, use {@link FTPClient} , which will handle all low level details for you.
	 * <p>
	 * 
	 * @return The reply code received from the server.
	 * @exception FTPConnectionClosedException
