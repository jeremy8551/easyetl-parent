...
package icu.etl.apache.net.ftp.parser;

import icu.etl.apache.net.ftp.Configurable;
import icu.etl.apache.net.ftp.FTPClient;
import icu.etl.apache.net.ftp.FTPClientConfig;
import icu.etl.apache.net.ftp.FTPFileEntryParser;
...
public class DefaultFTPFileEntryParserFactory implements FTPFileEntryParserFactory {
	 ...
	 *             thrown if for any reason the factory cannot resolve the supplied key into an FTPFileEntryParser.
	...
	public FTPFileEntryParser createFileEntryParser(String key) {
		...
		try {
			...
			try {
				...
				throw new ParserInitializationException(parserClass.getName() + " does not implement the interface " + FTPFileEntryParser.class.getName(), e);
			}
	 ...
	 * 
	 * @param config
	 *            A {@link FTPClientConfig FTPClientConfig} used to configure the parser created
	 * 		   
