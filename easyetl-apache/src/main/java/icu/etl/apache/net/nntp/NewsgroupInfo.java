...
/***
 * NewsgroupInfo stores information pertaining to a newsgroup returned by the NNTP GROUP, LIST, and NEWGROUPS commands, implemented by {@link NNTPClient#selectNewsgroup selectNewsgroup } , {@link NNTPClient#listNewsgroups listNewsgroups } , and {@link NNTPClient#listNewNewsgroups listNewNewsgroups } respectively.
 * <p>
 * <p>
 * 
...
public final class NewsgroupInfo {
	...
	/*
	 * public String toString() { StringBuilder buffer = new StringBuilder(); buffer.append(__newsgroup); buffer.append(' '); buffer.append(__lastArticle); buffer.append(' '); buffer.append(__firstArticle); buffer.append(' '); switch(__postingPermission) { case 1: buffer.append('m'); break; case 2: buffer.append('y'); break; case 3: buffer.append('n'); break; } return buffer.toString(); }
	 */
}
