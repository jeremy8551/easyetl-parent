...
package icu.etl.apache.net.chargen;
 ...
 * <p>
 * To use the CharGenTCPClient class, just establish a connection with {@link SocketClient#connect connect } and call {@link #getInputStream getInputStream() } to access the data. Don't close the input stream when you're done with it. Rather, call {@link SocketClient#disconnect disconnect } to clean up properly.
 * <p>
 * <p>
 * 
...
public final class CharGenTCPClient extends SocketClient {
	...
	/***
	 * Returns an InputStream from which the server generated data can be read. You should NOT close the InputStream when you're finished reading from it. Rather, you should call {@link SocketClient#disconnect disconnect } to clean up properly.
	 * <p>
	 * 
