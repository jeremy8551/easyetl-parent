...
public final class TFTPErrorPacket extends TFTPPacket {
	...
	/***
	 * Creates a UDP datagram containing all the TFTP error packet data in the proper format. This is a method exposed to the programmer in case he wants to implement his own TFTP client instead of using the {@link TFTPClient} class. Under normal circumstances, you should not have a need to call this method.
	 * <p>
	 * 
