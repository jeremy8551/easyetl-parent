...
/***
 * The NewGroupsOrNewsQuery class. This is used to issue NNTP NEWGROUPS and NEWNEWS queries, implemented by {@link NNTPClient#listNewNewsgroups listNewNewsGroups } and {@link NNTPClient#listNewNews listNewNews } respectively. It prevents you from having to format date, time, distribution, and newgroup arguments.
 * <p>
...
public final class NewGroupsOrNewsQuery {
	...
	/***
	 * Add a newsgroup to the list of newsgroups being queried. Newsgroups added this way are only meaningful to the NEWNEWS command. Newsgroup names may include the <code> * </code> wildcard, as in <code>comp.lang.* </code> or <code> comp.lang.java.* </code>. Adding at least one newsgroup is mandatory for the NEWNEWS command.
	 * <p>
	 * 
	 * @param newsgroup
	...
	/***
	 * Add a newsgroup to the list of newsgroups being queried, but indicate that group should not be checked for new news. Newsgroups added this way are only meaningful to the NEWNEWS command. Newsgroup names may include the <code> * </code> wildcard, as in <code>comp.lang.* </code> or <code> comp.lang.java.* </code>.
	 * <p>
