...
/***
 * An abstract class derived from TFTPPacket definiing a TFTP Request packet type. It is subclassed by the {@link TFTPReadRequestPacket} and {@link TFTPWriteRequestPacket} classes.
 * <p>
...
public abstract class TFTPRequestPacket extends TFTPPacket {
	 ...
	 * @param type
	 *            The type of the request (either TFTPPacket.READ_REQUEST or TFTPPacket.WRITE_REQUEST).
	 * @param filename
	...
	/***
	 * Creates a UDP datagram containing all the TFTP request packet data in the proper format. This is a method exposed to the programmer in case he wants to implement his own TFTP client instead of using the {@link TFTPClient} class. Under normal circumstances, you should not have a need to call this method.
	 * <p>
	 * 
