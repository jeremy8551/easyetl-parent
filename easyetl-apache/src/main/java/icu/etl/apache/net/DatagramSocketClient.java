...
public abstract class DatagramSocketClient {
	 ...
	 * 
	 * @param timeout
	 *            The timeout in milliseconds to use for the currently open datagram socket connection.
	 ***/
