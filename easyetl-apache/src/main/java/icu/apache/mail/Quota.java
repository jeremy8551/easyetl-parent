...
/**
 * This class represents a set of quotas for a given quota root. Each quota root has a set of resources, represented by the <code>Quota.Resource</code> class. Each resource has a name (for example, "STORAGE"), a current usage, and a usage limit. See RFC 2087.
 *
 * @since JavaMail 1.4
