 ...
 * <p>
 *
 * Note that this class differs from <code>java.net.URL</code> in that this class just represents the name of a URL, it does not model the connection to a URL.
 *
...
public class URLName {
	...
	/**
	 * The class contains a utility method for converting a <code>String</code> into a MIME format called "<code>x-www-form-urlencoded</code>" format.
	 * <p>
	 * To convert a <code>String</code>, each character is examined in turn:
	 * <ul>
	 * <li>The ASCII characters '<code>a</code>' through '<code>z</code>', '<code>A</code>' through '<code>Z</code>', '<code>0</code>' through '<code>9</code>', and &quot;.&quot;, &quot;-&quot;, &quot;*&quot;, &quot;_&quot; remain the same.
	 * <li>The space character '<code>&nbsp;</code>' is converted into a plus sign '<code>+</code>'.
	 * <li>All other characters are converted into the 3-character string "<code>%<i>xy</i></code>", where <i>xy</i> is the two-digit hexadecimal representation of the lower 8-bits of the character.
	 * </ul>
	 *
	...
	/*
	 * The list of characters that are not encoded have been determined by referencing O'Reilly's "HTML: The Definitive Guide" (page 164).
	 */
	...
	/**
	 * The class contains a utility method for converting from a MIME format called "<code>x-www-form-urlencoded</code>" to a <code>String</code>
	 * <p>
	 * To convert to a <code>String</code>, each character is examined in turn:
	 * <ul>
	 * <li>The ASCII characters '<code>a</code>' through '<code>z</code>', '<code>A</code>' through '<code>Z</code>', and '<code>0</code>' through '<code>9</code>' remain the same.
	 * <li>The plus sign '<code>+</code>'is converted into a space character '<code>&nbsp;</code>'.
	 * <li>The remaining characters are represented by 3-character strings which begin with the percent sign, "<code>%<i>xy</i></code>", where <i>xy</i> is the two-digit hexadecimal representation of the lower 8-bits of the character.
	 * </ul>
	 *
