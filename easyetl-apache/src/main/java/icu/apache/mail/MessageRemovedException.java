...
/**
 * The exception thrown when an invalid method is invoked on an expunged Message. The only valid methods on an expunged Message are <code>isExpunged()</code> and <code>getMessageNumber()</code>.
 *
