 ...
 */
public class EAHeader extends icu.apache.ant.unrar.rarfile.SubBlockHeader {
    /** JDK日志输出接口 */
    private final static Logger log = Logger.getLogger(EAHeader.class.getName());
    ...
    public EAHeader(icu.apache.ant.unrar.rarfile.SubBlockHeader sb, byte[] eahead) {
        super(sb);
        int pos = 0;
    ...
    public void print() {
        super.print();
        log.log(Level.INFO, "unpSize: " + unpSize);
        log.log(Level.INFO, "unpVersion: " + unpVer);
        log.log(Level.INFO, "method: " + method);
        log.log(Level.INFO, "EACRC:" + EACRC);
    }
}
