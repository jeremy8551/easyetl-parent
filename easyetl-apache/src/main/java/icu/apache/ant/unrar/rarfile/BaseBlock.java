...
public class BaseBlock {
    ...
    /** JDK日志输出接口 */
    private final static Logger log = Logger.getLogger(BaseBlock.class.getName());
    ...
    public boolean isSubBlock() {
        if (icu.apache.ant.unrar.rarfile.UnrarHeadertype.SubHeader.equals(headerType)) {
            return (true);
        }
        if (icu.apache.ant.unrar.rarfile.UnrarHeadertype.NewSubHeader.equals(headerType) && (flags & LHD_SOLID) != 0) {
            return (true);
        }
        return (false);
    ...
    public icu.apache.ant.unrar.rarfile.UnrarHeadertype getHeaderType() {
        return icu.apache.ant.unrar.rarfile.UnrarHeadertype.findType(headerType);
    }
