    ...
    private int compareTo(DatabaseTableColumn column1, DatabaseTableColumn column2) {
        ...
        if (nameCompare != 0) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName()));
            }
            return nameCompare;
        }
        ...
        if (column1.getSqlType() != column2.getSqlType()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getSqlType(), column2.getSqlType()));
            }
        ...
        if (typeNameCompare != 0) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getFieldType(), column2.getFieldType()));
            }
        ...
        if (column1.length() != column2.length()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.length(), column2.length()));
            }
        ...
        if (column1.getMaxLength() != column2.getMaxLength()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getMaxLength(), column2.getMaxLength()));
            }
        ...
        if (column1.getPosition() != column2.getPosition()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getPosition(), column2.getPosition()));
            }
        ...
        if (column1.getDigit() != column2.getDigit()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getDigit(), column2.getDigit()));
            }
        ...
        if (column1.getRadix() != column2.getRadix()) {
            if (STD.out.isDebugEnabled()) {
                STD.out.debug(ResourcesUtils.getDatabaseMessage(43, name1, column1.getPosition(), column1.getName(), name2, column2.getPosition(), column2.getName(), column1.getRadix(), column2.getRadix()));
            }
